public class OperadorInstanceOfTiposGenericos {
    public static void main(String[] args) {
        ...
        System.out.println("decimal es del Float = " + b1);

        b1 = decimal instanceof Number;
        System.out.println("decimal es del Number = " + b1);

        b1 = decimal instanceof Integer;
        System.out.println("decimal es del Integer = " + b1);
        ...
        System.out.println("b1 es del tipo Bolen = " + b1);
